...
import '../commissionsummary/cashinsummarycommission.dart';

class FetchCashInCommissionMonthly extends StatefulWidget {
  final username;
  const FetchCashInCommissionMonthly({Key? key,required this.username}) : super(key: key);

  @override
  State<FetchCashInCommissionMonthly> createState() => _FetchCashInCommissionMonthlyState(username:this.username);
}

class _FetchCashInCommissionMonthlyState extends State<FetchCashInCommissionMonthly> {
  final username;
  _FetchCashInCommissionMonthlyState({required this.username});
  ...
  //   });
  // }
  fetchAgentCashInTransactionsByMonth()async{
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("$username's cash in commission"),
        ),
        body: ListView(
          children: [
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  Text("Commission = ${cashReceived - sum}",style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white),),
                                ],
                              ),
                            ],
                          ),
