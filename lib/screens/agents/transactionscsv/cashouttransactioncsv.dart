...
class FetchCashOutToCsvMonthly extends StatefulWidget {
  final username;
  const FetchCashOutToCsvMonthly({Key? key,required this.username}) : super(key: key);

  @override
  State<FetchCashOutToCsvMonthly> createState() => _FetchCashOutToCsvMonthlyState(username:this.username);
}

class _FetchCashOutToCsvMonthlyState extends State<FetchCashOutToCsvMonthly> {
  final username;
  _FetchCashOutToCsvMonthlyState({required this.username});
  ...
  Future<void>sendTransactionDetailsToMail()async{
    final url = "https://fnetagents.xyz/export_momo_cash_out_transactions_csv/$username/$bMonth/$bYear/${controller.myEmail}/";
    var myLink = Uri.parse(url);
    final response = await http.get(myLink);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: secondaryColor,
          title: Text("$username's cash out transactions"),
        ),
                        ...
                        subtitle:  Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  const Text("Cash Paid : ",style: TextStyle(
                                      fontWeight:
                                      FontWeight
                                          .bold,
                                      fontSize:15,
                                      color:
                                      defaultWhite)),
                                  Text(items['cash_paid'],style: const TextStyle(
                                      fontWeight:
                                      FontWeight
                                          .bold,
                                      fontSize:15,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  const Text("Amount Received : ",style: TextStyle(
                                      fontWeight:
                                      FontWeight
                                          .bold,
                                      fontSize:15,
                                      color:
                                      defaultWhite)),
                                  Text(items['amount_received'],style: const TextStyle(
                                      fontWeight:
                                      FontWeight
                                          .bold,
                                      fontSize:15,
