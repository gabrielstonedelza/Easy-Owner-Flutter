...
class RequestsSummaryDetail extends StatefulWidget {
  ...
  final username;
  const RequestsSummaryDetail({Key? key, this.date_requested,required this.username})
      : super(key: key);

  @override
  _RequestsSummaryDetailState createState() =>
      _RequestsSummaryDetailState(date_requested: this.date_requested,username:this.username);
}

class _RequestsSummaryDetailState extends State<RequestsSummaryDetail> {
  final date_requested;
  final username;
  _RequestsSummaryDetailState({required this.date_requested,required this.username});
