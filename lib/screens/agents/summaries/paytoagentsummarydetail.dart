...
class PayToAgentSummaryDetail extends StatefulWidget {
  final username;
  final date_added;
  const PayToAgentSummaryDetail({Key? key, this.date_added,required this.username})
      : super(key: key);

  @override
  _PayToAgentSummaryDetailState createState() =>
      _PayToAgentSummaryDetailState(date_added: this.date_added,username:this.username);
}

class _PayToAgentSummaryDetailState extends State<PayToAgentSummaryDetail> {
  final date_added;
  final username;
  _PayToAgentSummaryDetailState({required this.date_added,required this.username});
